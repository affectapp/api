...
const Nonprofit$json = const {
  ...
  '2': const [
    ...
    const {'1': 'affiliate_id', '3': 9, '4': 1, '5': 9, '10': 'affiliateId'},
  ],
};

/// Descriptor for `Nonprofit`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List nonprofitDescriptor = $convert.base64Decode('');
