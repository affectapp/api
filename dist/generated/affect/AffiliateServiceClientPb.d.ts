...
export declare class AffiliateServiceClient {
    ...
    methodInfoRefreshAffiliate: grpcWeb.MethodDescriptor<affect_affiliate_pb.RefreshAffiliateRequest, affect_affiliate_pb.Affiliate>;
    refreshAffiliate(request: affect_affiliate_pb.RefreshAffiliateRequest, metadata: grpcWeb.Metadata | null): Promise<affect_affiliate_pb.Affiliate>;
    refreshAffiliate(request: affect_affiliate_pb.RefreshAffiliateRequest, metadata: grpcWeb.Metadata | null, callback: (err: grpcWeb.RpcError, response: affect_affiliate_pb.Affiliate) => void): grpcWeb.ClientReadableStream<affect_affiliate_pb.Affiliate>;
}
