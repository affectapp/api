...
goog.exportSymbol('proto.affect.ListNonprofitsRequest.SearchFilter', null, global);
goog.exportSymbol('proto.affect.ListNonprofitsResponse', null, global);
goog.exportSymbol('proto.affect.ListNonprofitsResponse.FilterBySearch', null, global);
goog.exportSymbol('proto.affect.ListNonprofitsResponse.FilterCase', null, global);
 ...
 * @constructor
 */
proto.affect.ListNonprofitsRequest.SearchFilter = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.affect.ListNonprofitsRequest.SearchFilter, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.affect.ListNonprofitsRequest.SearchFilter.displayName = 'proto.affect.ListNonprofitsRequest.SearchFilter';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.affect.ListNonprofitsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.affect.ListNonprofitsResponse.repeatedFields_, proto.affect.ListNonprofitsResponse.oneofGroups_);
};
 ...
 * @constructor
 */
proto.affect.ListNonprofitsResponse.FilterBySearch = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.affect.ListNonprofitsResponse.FilterBySearch, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.affect.ListNonprofitsResponse.FilterBySearch.displayName = 'proto.affect.ListNonprofitsResponse.FilterBySearch';
}
 ...
 * @const
 */
proto.affect.ListNonprofitsRequest.oneofGroups_ = [[3]];
...
proto.affect.ListNonprofitsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    searchFilter: (f = msg.getSearchFilter()) && proto.affect.ListNonprofitsRequest.SearchFilter.toObject(includeInstance, f)
  };
...
proto.affect.ListNonprofitsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.affect.ListNonprofitsRequest.SearchFilter;
      reader.readMessage(value,proto.affect.ListNonprofitsRequest.SearchFilter.deserializeBinaryFromReader);
...
proto.affect.ListNonprofitsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.affect.ListNonprofitsRequest.SearchFilter.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.affect.ListNonprofitsRequest.SearchFilter.prototype.toObject = function(opt_includeInstance) {
  return proto.affect.ListNonprofitsRequest.SearchFilter.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.affect.ListNonprofitsRequest.SearchFilter} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.affect.ListNonprofitsRequest.SearchFilter.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.affect.ListNonprofitsRequest.SearchFilter}
 */
proto.affect.ListNonprofitsRequest.SearchFilter.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.affect.ListNonprofitsRequest.SearchFilter;
  return proto.affect.ListNonprofitsRequest.SearchFilter.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.affect.ListNonprofitsRequest.SearchFilter} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.affect.ListNonprofitsRequest.SearchFilter}
 */
proto.affect.ListNonprofitsRequest.SearchFilter.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.affect.ListNonprofitsRequest.SearchFilter.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.affect.ListNonprofitsRequest.SearchFilter.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.affect.ListNonprofitsRequest.SearchFilter} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.affect.ListNonprofitsRequest.SearchFilter.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getQuery();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.affect.ListNonprofitsRequest.SearchFilter.prototype.getQuery = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.affect.ListNonprofitsRequest.SearchFilter} returns this
 */
proto.affect.ListNonprofitsRequest.SearchFilter.prototype.setQuery = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
/**
 * optional SearchFilter search_filter = 3;
 * @return {?proto.affect.ListNonprofitsRequest.SearchFilter}
 */
proto.affect.ListNonprofitsRequest.prototype.getSearchFilter = function() {
  return /** @type{?proto.affect.ListNonprofitsRequest.SearchFilter} */ (
    jspb.Message.getWrapperField(this, proto.affect.ListNonprofitsRequest.SearchFilter, 3));
};


/**
 * @param {?proto.affect.ListNonprofitsRequest.SearchFilter|undefined} value
 * @return {!proto.affect.ListNonprofitsRequest} returns this
*/
proto.affect.ListNonprofitsRequest.prototype.setSearchFilter = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.affect.ListNonprofitsRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.affect.ListNonprofitsRequest} returns this
 */
proto.affect.ListNonprofitsRequest.prototype.clearSearchFilter = function() {
 ...
 * @return {boolean}
 */
proto.affect.ListNonprofitsRequest.prototype.hasSearchFilter = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @const
 */
proto.affect.ListNonprofitsResponse.oneofGroups_ = [[4]];

/**
 * @enum {number}
 */
proto.affect.ListNonprofitsResponse.FilterCase = {
  FILTER_NOT_SET: 0,
  FILTER_BY_SEARCH: 4
};

/**
 * @return {proto.affect.ListNonprofitsResponse.FilterCase}
 */
proto.affect.ListNonprofitsResponse.prototype.getFilterCase = function() {
  return /** @type {proto.affect.ListNonprofitsResponse.FilterCase} */(jspb.Message.computeOneofCase(this, proto.affect.ListNonprofitsResponse.oneofGroups_[0]));
};
...
proto.affect.ListNonprofitsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    filterBySearch: (f = msg.getFilterBySearch()) && proto.affect.ListNonprofitsResponse.FilterBySearch.toObject(includeInstance, f)
  };
...
proto.affect.ListNonprofitsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.affect.ListNonprofitsResponse.FilterBySearch;
      reader.readMessage(value,proto.affect.ListNonprofitsResponse.FilterBySearch.deserializeBinaryFromReader);
...
proto.affect.ListNonprofitsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.affect.ListNonprofitsResponse.FilterBySearch.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.prototype.toObject = function(opt_includeInstance) {
  return proto.affect.ListNonprofitsResponse.FilterBySearch.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.affect.ListNonprofitsResponse.FilterBySearch} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.toObject = function(includeInstance, msg) {
  var f, obj = {
    query: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.affect.ListNonprofitsResponse.FilterBySearch}
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.affect.ListNonprofitsResponse.FilterBySearch;
  return proto.affect.ListNonprofitsResponse.FilterBySearch.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.affect.ListNonprofitsResponse.FilterBySearch} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.affect.ListNonprofitsResponse.FilterBySearch}
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.affect.ListNonprofitsResponse.FilterBySearch.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.affect.ListNonprofitsResponse.FilterBySearch} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getQuery();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.prototype.getQuery = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.affect.ListNonprofitsResponse.FilterBySearch} returns this
 */
proto.affect.ListNonprofitsResponse.FilterBySearch.prototype.setQuery = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {?proto.affect.ListNonprofitsResponse.FilterBySearch}
 */
proto.affect.ListNonprofitsResponse.prototype.getFilterBySearch = function() {
  return /** @type{?proto.affect.ListNonprofitsResponse.FilterBySearch} */ (
    jspb.Message.getWrapperField(this, proto.affect.ListNonprofitsResponse.FilterBySearch, 4));
};


/**
 * @param {?proto.affect.ListNonprofitsResponse.FilterBySearch|undefined} value
 * @return {!proto.affect.ListNonprofitsResponse} returns this
*/
proto.affect.ListNonprofitsResponse.prototype.setFilterBySearch = function(value) {
  return jspb.Message.setOneofWrapperField(this, 4, proto.affect.ListNonprofitsResponse.oneofGroups_[0], value);
};
 ...
 * @return {!proto.affect.ListNonprofitsResponse} returns this
 */
proto.affect.ListNonprofitsResponse.prototype.clearFilterBySearch = function() {
 ...
 * @return {boolean}
 */
proto.affect.ListNonprofitsResponse.prototype.hasFilterBySearch = function() {
